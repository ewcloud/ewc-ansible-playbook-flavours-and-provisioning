...
| [htc-execute-flavour](./playbooks/htc-execute-flavour/) | Enables users to contribute with VMs towards the shared resources pool of the EWC HTC Batch Processing service. |
| [htc-submit-flavour](./playbooks/htc-submit-flavour/) | Setups a workspace from where users can submit computation tasks onto the shared resource pool managed by EWC HTC Batch Processing service. |
